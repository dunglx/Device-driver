...
//BANGDC add for SFH7776
static int sfh7776_power(int pwr_device, uint8_t enable)
{
	//cofigurate power supply
	if (enable)
	{
	    //add your code
	}
...
static struct sfh7776_platform_data sfh7776_pdata = {
	.power = sfh7776_power,
	.intr = 74,
	...
	.als_level_table = {4, 40,  80,   120,   160, 250,  400, 800, 1200,  1600, 2000, 3000, 5000, 10000, 65535},
	.als_value_table = {10, 20,20,  120, 120, 280,  280,  280, 1600,  1600,  1600,  6000,  6000, 9000,  10240, 10240},
...
static struct i2c_board_info i2c_devices4[] = {
	{
		I2C_BOARD_INFO(SFH7776_I2C_NAME, 0x39),
		.platform_data = &sfh7776_pdata,
	},
};
//
...
void __init msm8974_init(void)
{
	...
	msm8974_add_drivers();
	//BANGDC add for SFH
	i2c_register_board_info(2, i2c_devices4,ARRAY_SIZE(i2c_devices4));//i2c bus 2 with touch
	//
}
